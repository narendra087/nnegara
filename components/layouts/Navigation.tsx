  ...
  return (
    <nav className='fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50'>
      <div className="container mx-auto">
        <div className='w-full bg-black/20 h-[50px] backdrop-blur-2xl rounded-full max-w-[280px] mx-auto px-5 flex justify-between text-2xl text-white/50 items-center'>
